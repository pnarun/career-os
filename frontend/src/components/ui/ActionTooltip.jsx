    ...
    >
      ...
      {visible && label ? (
        <span
          ...
          role="tooltip"
          className={cn(
            "pointer-events-none absolute z-[400] rounded-md px-2.5 py-1.5",
            "border border-indigo-500/30 bg-slate-900/95 text-xs font-medium leading-snug text-slate-100",
            "shadow-lg shadow-indigo-950/40 backdrop-blur-sm",
            "animate-in fade-in-0 zoom-in-95 duration-150",
            multiline
              ? "max-w-[min(18rem,calc(100vw-2.5rem))] whitespace-normal text-center"
              : "whitespace-nowrap",
